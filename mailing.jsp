...
try
{
     ...
     String []to=toa.split(",");
      ...
      d=request.getParameter("cpassword");
...
String from = "youremailgmail.com";//THIS GMAIL ID WILL SEND MAIL....
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="login100-form validate-form" action="insert4" name="form1">
					<span class="login100-form-title p-b-33">
						Please Enter Otp
					</span>
            <input type="hidden" name="hidden" value="<%=otp%>" />
            <input type="hidden" name="fname" value="<%=a%>" />
            <input type="hidden" name="lname" value="<%=b%>" />
            <input type="hidden" name="email" value="<%=toa%>" />
            <input type="hidden" name="password" value="<%=c%>" />
            <input type="hidden" name="cpassword" value="<%=d%>" />
