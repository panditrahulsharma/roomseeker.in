    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="admin"><img class="main-logo" src="admin/img/logo/logo.png" alt="" /></a>
                <strong><a href="admin"><img src="admin/img/logo/logosn.png" alt="" /></a></strong>
            </div>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Professor Profile" href="admin"><span class="mini-sub-pro">Admin Profile</span></a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Library" href="post"><span class="mini-sub-pro">All Posts</span></a></li>
                                </ul>
                        </li>
                        ...
                        <li id="removable">
                            ...
                            <ul class="submenu-angle page-mini-nb-dp" aria-expanded="false">
                                ...
                                <li><a title="Lock" href="lock"><span class="mini-sub-pro">Lock</span></a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          ...
                          <i class="educate-icon educate-nav"></i>
                              ...
                              <span class="admin-name">pw.println(s2+" "+s3);</span>
                              <i class="fa fa-angle-down edu-icon edu-down-arrow"></i>
                            </a>
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        <li><a href="admin"><span class="edu-icon edu-home-admin author-log-ic"></span>My Account</a>
                                                        </li>
                                                        <li><a href="admin"><span class="edu-icon edu-user-rounded author-log-ic"></span>My Profile</a>
                                                        </li>
                                                   
                                                        <li><a href="admin"><span class="edu-icon edu-settings author-log-ic"></span>Settings</a>
                                                        </li>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="admin">Home <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent" href="#">Professors <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demoevent" class="collapse dropdown-header-top">
                                                <li><a href="admin">admin profile</a>
                                                </li>
                        ...
                        <div class="product-status-wrap">
                            ...
                            <div class="asset-inner">
                                <table>
                                 ...
                                 rs2=st2.executeQuery("select post.postid,post.img1,post.title,post.catagary,post.properties,post.ptype,near.nearname,post.price from post inner join near on near.nearid=post.nearid
                           while(rs2.next())
                           {
                                  m1=rs2.getInt(1);
                                  k1=rs2.getString(2);
                                    ...
                                    <tr>
                                        <td>pw.println(m1);</td>
                                        <td><img src="admin/img/product/book-1.jpg" alt="" /></td>
                                        <td>pw.println(k2);</td>
                                        <td>
                                         ;pw.println(k5);
                                        </td>
