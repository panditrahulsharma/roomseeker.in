...
//pw.println("<script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/2.2.3/jquery.min.js'></script>");
               pw.println("<script type='text/javascript'>");
       pw.println(" $('.product-list').click(function() {");
            pw.println("$(this).siblings('input:checkbox').prop('checked', false);");
       pw.println(" });");
      pw.println("</script>");
  //pw.println("<script src='https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js'>");pw.println("</script>");
    ...
    pw.println("<div class='banner-info'>");
      ...
      pw.println("<div id='searchfield'>");
        pw.println("<form action='searchroom'>");
          pw.println("<input type='text' name='k1' class='biginput' id='autocomplete'  placeholder='Enter location' required=''>");
          
          pw.println("<select id='country' onchange='change_country(this.value)' name='k2'  class='biginput'>");
            pw.println("<option value='null'>");pw.println("<img src='images/rupee.png' alt=' ' class='img-responsive' />");pw.println("select Property type");pw.println("</option>");
...
pw.println("<!-- discounts-->");
          ...
          pw.println("<div class='search-car-inner w3l'>");
            ...
            pw.println("<button class='btn btn-primary fill1' id='Mybtn'>"); pw.println("Filter");pw.println("</button>");
             ...
             pw.println("<h4>");pw.println("Select price");pw.println("</h4>");
               ...
               pw.println("<label class='checkbox'>");pw.println("<input type='checkbox' name='price' class='product-list' value='2000'>");pw.println("<i>");pw.println("</i>");pw.println("rs.1500-2000");pw.println("</label>");
               pw.println("<label class='checkbox'>");pw.println("<input type='checkbox' name='price' class='product-list' value='4000'>");pw.println("<i>");pw.println("</i>");pw.println("rs.2000-4000");pw.println("</label>");
               pw.println("<label class='checkbox'>");pw.println("<input type='checkbox' name='price' class='product-list' value='6000'>");pw.println("<i>");pw.println("</i>");pw.println("rs.4000-6000");pw.println("</label>");
                  ...
                  pw.println("<section class='sky-form'>");
                    pw.println("<h4>");pw.println("Search Rent for");pw.println("</h4>");
                     pw.println("<div class='form-inner'>");
                              pw.println("<label class='checkbox'>");pw.println("<input type='checkbox' name='rent' value='student' class='product-list1'>");pw.println("<i>");pw.println("</i>");pw.println("Students");pw.println("</label>");
                              pw.println("<label class='checkbox'>");pw.println("<input type='checkbox' name='rent' value='family' class='product-list1'>");pw.println("<i>");pw.println("</i>");pw.println("family");pw.println("</label>");
                                pw.println("<label class='checkbox'>");pw.println("<input type='checkbox' name='rent' value='Professional' class='product-list1'>");pw.println("<i>");pw.println("</i>");pw.println("Professional");pw.println("</label>");
                            pw.println("</div>");
                  pw.println("</section>");
                  ...
                  pw.println("<section class='sky-form'>");
                        pw.println("<h4>");pw.println("Select category");pw.println("</h4>");
                              ...
                              pw.println("<label class='checkbox'>");pw.println("<input type='checkbox' name='category' class='product-list2' value='rooms'>");pw.println("<i>");pw.println("</i>");pw.println("Rooms");pw.println("</label>");
                              pw.println("<label class='checkbox'>");pw.println("<input type='checkbox' name='category' class='product-list2' value='hostel'>");pw.println("<i>");pw.println("</i>");pw.println("Hostels");pw.println("</label>");
                             pw.println("<label class='checkbox'>");pw.println("<input type='checkbox' name='category' class='product-list2' value='flat'>");pw.println("<i>");pw.println("</i>");pw.println("Flats");pw.println("</label>");
                             pw.println("<label class='checkbox'>");pw.println("<input type='checkbox' name='category' class='product-list2' value='shop'>");pw.println("<i>");pw.println("</i>");pw.println("Shops");pw.println("</label>");
                  ...
                  pw.println("<section class='sky-form'>");
                        pw.println("<h4>");pw.println("Preferred Gender");pw.println("</h4>");
                                ...
                                pw.println("<div class='form-inner'>");
                              pw.println("<label class='checkbox'>");pw.println("<input type='checkbox' name='Gender' class='product-list3' value='male'>");pw.println("<i>");pw.println("</i>");pw.println("Male");pw.println("</label>");
                              pw.println("<label class='checkbox'>");pw.println("<input type='checkbox' name='Gender' class='product-list3' value='female'>");pw.println("<i>");pw.println("</i>");pw.println("Female");pw.println("</label>");
                  ...
                  pw.println("<section class='sky-form'>");
                    pw.println("<h4>");pw.println("properties");pw.println("</h4>");
                     pw.println("<div class='form-inner'>");
                              pw.println("<label class='checkbox'>");pw.println("<input type='checkbox' name='properties' class='product-list5' value='rent'>");pw.println("<i>");pw.println("</i>");pw.println("Rent");pw.println("</label>");
                              pw.println("<label class='checkbox'>");pw.println("<input type='checkbox' name='properties' class='product-list5' value='sale'>");pw.println("<i>");pw.println("</i>");pw.println("Sale");pw.println("</label>");
   ...
   try
   {
                      ...
                      rs2=st2.executeQuery("select max(postid) from post");
        while(rs2.next())
          {       
               m1=rs2.getInt(1);
              if(m1>15)
              {
                               ...
                               try
               {
                  st3=con.createStatement();
                   rs3=st3.executeQuery("select post.pathh,post.email,post.img1,post.price,post.catagary,post.properties,post.ptype,near.nearname,post.title from post inner join near on near.nearid=post.nearid and postid='"+i+"'");
                   while(rs3.next())
                   {
           ...
           pw.println("<div class='item  col-xs-4 col-lg-4'>");
                  pw.println("<div class='thumbnail thumbnail1'>");
                     pw.println("<a href='des?post1="+i+"' data-toggle='modal' >");pw.println("<img class='group list-group-image' src='postpic/"+s1+"/"+c5+"/"+p8+"' alt='no image found' width='150px' height='150px'>");pw.println("</a>");
                                           pw.println("<div class='table-text'>");
                                                                pw.println("<h4 >");pw.println("<a href='des?post1="+i+"' title='Maruti Suzuki 800 AC' class='click-search'>");pw.println("<span class='spancarname'>");pw.println(p7);pw.println("</span>");pw.println("</a>");pw.println("</h4>");
                                                                pw.println("<p class='gridViewPrice hide'>");
                                                                    pw.println("<a href='des?post1="+i+"'>");
                                ...
                                pw.println("<div class='clearfix'>");pw.println("</div>");                                  
                                     ...
                                     pw.println("<form action='des?post1="+i+"' method='post'>");
                                       pw.println("<input type='text' class='phone' placeholder='send message..' required=''>");
                                     pw.println("</form>");
                                  pw.println("</div>");
                                  pw.println("<div class='get-one'>");pw.println("<a href='des?post1="+i+"'>");pw.println("send message");pw.println("<a>");pw.println("</div>");
                                                                    pw.println("<div class='clearfix'>");pw.println("</div>");
                                                                pw.println("</div>");
              ...
              else
              {
               ...
               {
                  st3=con.createStatement();
                   rs3=st3.executeQuery("select post.pathh,post.email,post.img1,post.price,post.catagary,post.properties,post.ptype,near.nearname,post.title,post.email from post inner join near on near.nearid=post.nearid and postid='"+i+"'");
                   while(rs3.next())
                   { 
                   // m8=rs3.getInt(1);
                   	c5=rs3.getString(1);
